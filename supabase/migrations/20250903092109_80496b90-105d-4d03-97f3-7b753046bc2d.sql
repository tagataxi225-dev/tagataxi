-- Enhanced intelligent places search function
...
-- Massive data insert for real functionality
...
-- KINSHASA - Major zones and districts (Level 1-2)
('Gombe', 'Gombe', 'Gombe', 'commune', 'administrative', 'CD', 'Kinshasa', 'Gombe', -4.3276, 15.3154, true, ARRAY['centre', 'administratif', 'affaires'], 1, 95, ARRAY['centre-ville', 'downtown']),
('Bandalungwa', 'Bandalungwa', 'Bandalungwa', 'commune', 'residential', 'CD', 'Kinshasa', 'Bandalungwa', -4.3842, 15.2854, true, ARRAY['residentiel', 'populaire'], 1, 85, ARRAY['banda']),
('Barumbu', 'Barumbu', 'Barumbu', 'commune', 'residential', 'CD', 'Kinshasa', 'Barumbu', -4.3098, 15.3542, true, ARRAY['residentiel', 'central'], 1, 80, ARRAY[]); 

-- Extend with 500+ more locations for Kinshasa
INSERT INTO public.places_database (
  name, name_fr, name_local, place_type, category, country_code, city, commune, 
  latitude, longitude, is_popular, search_keywords, hierarchy_level, popularity_score, aliases
) VALUES
-- Major landmarks and POIs (Level 3-4)
...
('Marché Central', 'Marché Central', 'Zando ya Central', 'market', 'commerce', 'CD', 'Kinshasa', 'Gombe', -4.3217, 15.3069, true, ARRAY['marche', 'commerce', 'shopping'], 3, 90, ARRAY['central market']),
...
('Marché de la Liberté', 'Marché de la Liberté', 'Zando ya Liberté', 'market', 'commerce', 'CD', 'Kinshasa', 'Kalamu', -4.3398, 15.3198, true, ARRAY['marche', 'liberte', 'commerce'], 4, 75, ARRAY['liberty market']);

-- LUBUMBASHI locations (50+ entries)
INSERT INTO public.places_database (
  name, name_fr, name_local, place_type, category, country_code, city, commune, 
  latitude, longitude, is_popular, search_keywords, hierarchy_level, popularity_score, aliases
) VALUES
...
('Hôpital Sendwe', 'Hôpital Sendwe', 'Hopital Sendwe', 'hospital', 'health', 'CD', 'Lubumbashi', 'Lubumbashi', -11.6698, 27.4987, true, ARRAY['hopital', 'sante'], 3, 80, ARRAY['sendwe hospital']),
('Marché Central Lubumbashi', 'Marché Central de Lubumbashi', 'Zando ya Central Lubumbashi', 'market', 'commerce', 'CD', 'Lubumbashi', 'Lubumbashi', -11.6754, 27.5043, true, ARRAY['marche', 'central'], 3, 75, ARRAY['central market lubumbashi']);

-- KOLWEZI locations (30+ entries)
INSERT INTO public.places_database (
  name, name_fr, name_local, place_type, category, country_code, city, commune, 
  latitude, longitude, is_popular, search_keywords, hierarchy_level, popularity_score, aliases
) VALUES
...
('Hôpital Général de Kolwezi', 'Hôpital Général de Kolwezi', 'Hopital Général ya Kolwezi', 'hospital', 'health', 'CD', 'Kolwezi', 'Kolwezi', -10.7165, 25.4687, true, ARRAY['hopital', 'sante'], 3, 80, ARRAY['general hospital kolwezi']),
('Marché Central Kolwezi', 'Marché Central de Kolwezi', 'Zando ya Central Kolwezi', 'market', 'commerce', 'CD', 'Kolwezi', 'Kolwezi', -10.7132, 25.4698, true, ARRAY['marche', 'central'], 3, 75, ARRAY['central market kolwezi']);
