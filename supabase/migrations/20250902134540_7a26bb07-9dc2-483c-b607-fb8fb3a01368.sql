-- CRITICAL: Fix Admin Personal Information Exposure
-- Secure the admins table from unauthorized access

-- First, create audit logging for admin data access
...
-- Only super admins can view admin access logs
...
-- System can insert admin access logs
