...
-- Phase 1: Ajouter 500+ lieux pour Lubumbashi
...
('Hôpital Sendwe', 'santé', 'hôpital', 'Lubumbashi', 'Lubumbashi', NULL, 'Avenue Sendwe', -11.6550, 27.4800, 5, 88, true, true, ARRAY['Hôpital Jason Sendwe']),

-- LUBUMBASHI - Centres commerciaux et entreprises
('Shoprite Lubumbashi', 'commerce', 'supermarché', 'Lubumbashi', 'Annexe', NULL, 'Avenue Kasavubu', -11.6580, 27.4810, 4, 85, true, true, ARRAY['Shoprite', 'Supermarché Shoprite']),
...
('Hotel Karavia', 'hospitalité', 'hôtel', 'Lubumbashi', 'Annexe', NULL, 'Avenue Kasavubu', -11.6575, 27.4805, 4, 78, true, true, ARRAY['Karavia Hotel']),
...
('Avenue Lumumba', 'transport', 'avenue', 'Lubumbashi', 'Lubumbashi', 'Centre-ville', 'Avenue Lumumba', -11.6594, 27.4794, 3, 90, true, true, ARRAY['Av. Lumumba']),
('Avenue Kasavubu', 'transport', 'avenue', 'Lubumbashi', 'Annexe', NULL, 'Avenue Kasavubu', -11.6580, 27.4810, 3, 85, true, true, ARRAY['Av. Kasavubu']),
('Avenue Sendwe', 'transport', 'avenue', 'Lubumbashi', 'Lubumbashi', NULL, 'Avenue Sendwe', -11.6550, 27.4800, 3, 80, true, true, ARRAY['Av. Sendwe']),
...
('Aéroport de Kolwezi', 'transport', 'aéroport', 'Kolwezi', 'Kolwezi', NULL, NULL, -10.7689, 25.5056, 5, 95, true, true, ARRAY['Airport Kolwezi']),
('Mine de Mutanda', 'industrie', 'mine', 'Kolwezi', 'Mutoshi', NULL, NULL, -10.6900, 25.4400, 5, 88, true, true, ARRAY['Mutanda Mining']),
...
-- KINSHASA - Enrichissement massif (ajout de 200+ lieux supplémentaires)
-- Quartiers manquants
...
('Aéroport International de Ndjili', 'transport', 'aéroport', 'Kinshasa', 'Ndjili', 'Ndjili', NULL, -4.3867, 15.4444, 5, 100, true, true, ARRAY['Ndjili Airport', 'FIH Airport', 'Aéroport Ndjili']),
...
-- Mise à jour des scores de popularité et ajout de métadonnées
UPDATE public.intelligent_places 
SET 
  popularity_score = CASE 
    WHEN category = 'transport' AND subcategory = 'aéroport' THEN 100
    WHEN category = 'éducation' AND subcategory = 'université' THEN 95
    WHEN category = 'commerce' AND subcategory = 'centre commercial' THEN 90
    WHEN category = 'santé' AND subcategory = 'hôpital' THEN 88
    WHEN category = 'quartier' THEN 85
...
WHERE city IN ('Lubumbashi', 'Kolwezi', 'Kinshasa');
