-- Phase 1 simplifiée: Ajouter des données de test pour chauffeurs et marketplace

-- Supprimer d'abord les éventuelles données existantes pour éviter les conflits
...
-- Insérer les profils utilisateur de base
...
-- Ajouter les positions GPS des chauffeurs
