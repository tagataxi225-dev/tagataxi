-- PHASE 4: SÉCURITÉ CRITIQUE - Correction complète des fonctions
-- Fix Function Search Path Mutable issues for all functions

-- 1. Fix intelligent_places_search function
CREATE OR REPLACE FUNCTION public.intelligent_places_search(
