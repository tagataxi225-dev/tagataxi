-- Phase 1: Fix Role Permissions System (corrected)
...
-- Default user permissions (without admin_role)
...
ON CONFLICT (role, permission) DO NOTHING WHERE admin_role IS NULL;