-- =============================================
-- SOLUTION COMPLÈTE ABONNEMENTS UNIFIÉS (Version 2)
-- =============================================

-- 1. Supprimer les anciennes policies si elles existent puis les recréer
DROP POLICY IF EXISTS "chauffeurs_admin_read_for_subscriptions" ON public.chauffeurs;
DROP POLICY IF EXISTS "partenaires_admin_read_for_subscriptions" ON public.partenaires;

-- Policies pour permettre aux admins et utilisateurs de lire leurs profils
