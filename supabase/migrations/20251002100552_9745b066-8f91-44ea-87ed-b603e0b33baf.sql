-- Corriger le trigger handle_new_user pour inclure toutes les colonnes NOT NULL de partenaires
...
BEGIN
  ...
  ELSIF user_role_from_metadata = 'partner' THEN
    -- FIX: Ajouter display_name, business_type et address pour éviter l'erreur NULL constraint
