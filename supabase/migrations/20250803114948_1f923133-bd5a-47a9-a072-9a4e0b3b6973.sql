-- Phase 1 corrigée: Ajouter des données de test avec les bonnes valeurs de condition
...
-- Ajouter des produits marketplace de test avec les bonnes valeurs de condition
