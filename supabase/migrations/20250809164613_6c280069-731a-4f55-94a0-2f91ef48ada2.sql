...
INSERT INTO public.role_permissions (role, admin_role, permission, is_active) VALUES
  ...
  ('admin', 'admin_marketplace', 'notifications_write', true),
  ('admin', 'admin_marketplace', 'notifications_read', true),
  ('admin', 'admin_financier', 'notifications_read', true),
  ('admin', 'moderator', 'notifications_read', true)
