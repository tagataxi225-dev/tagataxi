...
-- Fixed empty array casting issue
...
('Commune de Kintambo', 'Kintambo', 'Kintambo', 'commune', 'administrative', 'CD', 'Kinshasa', 
 ...
 ARRAY['kintambo'], ARRAY[]::text[], true),

('Commune de Limete', 'Limete', 'Limete', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.3667, 15.3000, 2, 90, true, 
 ARRAY['limete'], ARRAY[]::text[], true),

('Commune de Kalamu', 'Kalamu', 'Kalamu', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.3500, 15.3167, 2, 80, true, 
 ARRAY['kalamu'], ARRAY[]::text[], true),

('Commune de Matete', 'Matete', 'Matete', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.3833, 15.3333, 2, 85, true, 
 ARRAY['matete'], ARRAY[]::text[], true),

-- More communes
('Commune de Ndjili', 'Ndjili', 'Ndjili', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.3857, 15.4446, 2, 85, true, 
 ARRAY['ndjili'], ARRAY[]::text[], true),

('Commune de Lemba', 'Lemba', 'Lemba', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.4167, 15.2833, 2, 80, true, 
 ARRAY['lemba'], ARRAY[]::text[], true),

('Commune de Ngaliema', 'Ngaliema', 'Ngaliema', 'commune', 'administrative', 'CD', 'Kinshasa', 
 -4.3667, 15.2833, 2, 85, true, 
 ARRAY['ngaliema'], ARRAY[]::text[], true),
