...
('Université de Kinshasa (UNIKIN)', 'éducation', 'université', 'Kinshasa', 'Lemba', 'Campus', 'Avenue de l\'Université', -4.4056, 15.2889, 5, 92, true, 'CD', ARRAY['UNIKIN', 'Campus Universitaire'], true),
('Hôpital Général de Kinshasa', 'santé', 'hôpital', 'Kinshasa', 'Gombe', 'Gombe', 'Avenue de l\'Hôpital', -4.3100, 15.3000, 4, 88, true, 'CD', ARRAY['Hôpital Central'], true),

-- Transport et aéroports de Kinshasa
('Aéroport International de N\'djili', 'transport', 'aéroport', 'Kinshasa', 'N\'djili', 'Aéroport', 'Route de l\'Aéroport', -4.3856, 15.4444, 5, 100, true, 'CD', ARRAY['Aéroport de Kinshasa', 'N\'djili Airport'], true),
...
('Université de Lubumbashi (UNILU)', 'éducation', 'université', 'Lubumbashi', 'Lubumbashi', 'Campus', 'Avenue de l\'Université', -11.6550, 27.4600, 5, 90, true, 'CD', ARRAY['UNILU', 'Campus Universitaire Lubumbashi'], true),
('Aéroport International de Luano', 'transport', 'aéroport', 'Lubumbashi', 'Annexe', 'Luano', 'Route de l\'Aéroport', -11.5911, 27.5306, 5, 95, true, 'CD', ARRAY['Aéroport de Lubumbashi'], true),
...
('Aéroport Félix Houphouët-Boigny', 'transport', 'aéroport', 'Abidjan', 'Port-Bouët', 'Aéroport', 'Route de l\'Aéroport', 5.2539, -3.9264, 5, 100, true, 'CI', ARRAY['Aéroport d\'Abidjan'], true),
('Université Félix Houphouët-Boigny', 'éducation', 'université', 'Abidjan', 'Cocody', 'Campus', 'Avenue de l\'Université', 5.3400, -4.0100, 5, 90, true, 'CI', ARRAY['Université d\'Abidjan'], true),
('Marché d\'Adjamé', 'commerce', 'marché', 'Abidjan', 'Adjamé', 'Centre', 'Avenue d\'Adjamé', 5.3600, -4.0200, 4, 92, true, 'CI', ARRAY['Grand Marché Adjamé'], true),
...
-- Mise à jour des vecteurs de recherche pour une meilleure recherche textuelle
