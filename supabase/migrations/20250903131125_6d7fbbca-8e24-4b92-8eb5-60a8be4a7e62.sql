-- Enrichir la base de données avec plus de lieux pour améliorer la recherche
-- Ajouter des lieux populaires supplémentaires pour Kinshasa, Lubumbashi et Kolwezi

-- Lieux supplémentaires pour Kinshasa
...
('Matonge', 'Quartier', 'Commercial', 'Kinshasa', 'Kalamu', 'Matonge', NULL, -4.3398, 15.2912, 3, 95, true, true, ARRAY['Matonge Center']),
...
('Marché Central', 'Commerce', 'Marché', 'Kinshasa', 'Gombe', 'Centre-ville', 'Avenue Tombalbaye', -4.3217, 15.3069, 4, 90, true, true, ARRAY['Grand Marché', 'Marché de Kinshasa']),
('City Market', 'Commerce', 'Centre Commercial', 'Kinshasa', 'Gombe', 'Centre-ville', 'Boulevard du 30 Juin', -4.3189, 15.3045, 4, 88, true, true, ARRAY['Shopping Center']),
...
('Parc Municipal', 'Loisirs', 'Parc', 'Kolwezi', 'Kolwezi', 'Centre', NULL, -10.7167, 25.4623, 2, 68, true, true, ARRAY['Parc Central']);
