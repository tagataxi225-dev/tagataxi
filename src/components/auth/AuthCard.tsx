...
export const AuthCard = ({ children, className = '', delay = 0.2 }: AuthCardProps) => {
  return (
    ...
    >
      ...
      <div className="relative backdrop-blur-xl bg-white/80 dark:bg-card/80 border border-white/50 dark:border-border/50 rounded-3xl shadow-2xl shadow-rose-500/5 dark:shadow-rose-500/10 overflow-hidden">
