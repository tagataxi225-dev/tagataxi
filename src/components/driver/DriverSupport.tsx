...
const DriverSupport = () => {
  ...
  const driverCategories = [
    { value: "paiements", label: "Paiements & Commissions", icon: CreditCard },
    { value: "courses", label: "Problèmes de courses", icon: Car },
    { value: "vehicule", label: "Questions véhicule", icon: Settings },
    { value: "partenaire", label: "Relation partenaire", icon: Users },
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold">Support Chauffeur</h1>
          <p className="text-muted-foreground">Nous sommes là pour vous aider 24h/24</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {contactMethods.map((method, index) => {
              ...
              return (
                <Card key={index} className={`transition-all duration-200 hover:shadow-md ${method.urgent ? 'border-red-200 bg-red-50' : ''}`}>
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      <div className={`p-2 rounded-lg ${method.urgent ? 'bg-red-100' : 'bg-blue-100'}`}>
                        <IconComponent className={`w-5 h-5 ${method.urgent ? 'text-red-600' : 'text-blue-600'}`} />
                      </div>
