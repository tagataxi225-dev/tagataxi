...
const tarifsOffline: Record<string, Record<string, { base: number; perKm: number; currency: string }>> = {
  kinshasa: {
    moto_taxi: { base: 1500, perKm: 500, currency: 'XOF' },
    taxi_eco: { base: 2500, perKm: 1500, currency: 'XOF' },
    taxi_confort: { base: 3200, perKm: 1800, currency: 'XOF' },
    taxi_premium: { base: 4300, perKm: 2300, currency: 'XOF' },
    delivery_flash: { base: 7000, perKm: 500, currency: 'XOF' },
    delivery_flex: { base: 55000, perKm: 2500, currency: 'XOF' },
    delivery_maxicharge: { base: 100000, perKm: 5000, currency: 'XOF' }
  },
  lubumbashi: {
    moto_taxi: { base: 1800, perKm: 600, currency: 'XOF' }, // +20%
    taxi_eco: { base: 3000, perKm: 1800, currency: 'XOF' },
    taxi_confort: { base: 3840, perKm: 2160, currency: 'XOF' },
    taxi_premium: { base: 5160, perKm: 2760, currency: 'XOF' },
    delivery_flash: { base: 8400, perKm: 600, currency: 'XOF' },
    delivery_flex: { base: 66000, perKm: 3000, currency: 'XOF' },
    delivery_maxicharge: { base: 120000, perKm: 6000, currency: 'XOF' }
  },
  kolwezi: {
    moto_taxi: { base: 1650, perKm: 550, currency: 'XOF' }, // +10%
    taxi_eco: { base: 2750, perKm: 1650, currency: 'XOF' },
    taxi_confort: { base: 3520, perKm: 1980, currency: 'XOF' },
    taxi_premium: { base: 4730, perKm: 2530, currency: 'XOF' },
    delivery_flash: { base: 7700, perKm: 550, currency: 'XOF' },
    delivery_flex: { base: 60500, perKm: 2750, currency: 'XOF' },
    delivery_maxicharge: { base: 110000, perKm: 5500, currency: 'XOF' }
  },
  abidjan: {
